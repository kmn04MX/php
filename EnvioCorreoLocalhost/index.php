	...
	<form method="post">
		...
		<?php
			if (isset($_POST['send'])){
				...
				$mail_username='app-mx-vidanta@mapfre.net';//Correo electronico saliente ejemplo: tucorreo@gmail.com
				$mail_userpassword='27mHnRftuKeMlX3';//Tu contraseña de gmail
				$mail_addAddress='afelipef7@gmail.com';//correo electronico que recibira el mensaje
